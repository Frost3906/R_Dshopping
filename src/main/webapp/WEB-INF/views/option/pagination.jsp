		...
		<div style="display: table; margin-left: auto; margin-right: auto;">
		  <ul class="pagination mb-3">
		    ...
		    <li class="page-item <c:if test='${pageVO.prev}'>disabled</c:if>">
		      <a class="page-link page-select" href="${pageVO.previousPage}" tabindex="-1" aria-disabled="true">Previous</a>
		    </li>
		    ...
		    <li class="page-item <c:if test='${pageVO.next}'>disabled</c:if>">
		      <a class="page-link page-select" href="${pageVO.nextPage}">Next</a>
		    </li>
		    <li class="page-item"><a class="page-link page-move" href="#">...</a></li>
		    <li class="page-item">
		      <a class="page-link page-select" href="${pageVO.lastPage}">Last</a>
		    </li>
		  </ul>
		</div>